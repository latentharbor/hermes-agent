...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "WEIXIN_ALLOWED_USERS", "WEIXIN_ALLOW_ALL_USERS", "WEIXIN_HOME_CHANNEL",
...
OPTIONAL_ENV_VARS = {
    ...
    "WEIXIN_TOKEN": {
        "description": "WeChat bot token returned by Hermes QR login",
        "prompt": "WeChat token",
        "url": None,
        "password": True,
        "category": "messaging",
    ...
    "WEIXIN_ACCOUNT_ID": {
        "description": "WeChat iLink account ID returned by Hermes QR login",
    ...
    "WEIXIN_BASE_URL": {
        "description": "WeChat iLink API base URL override",
    ...
    "WEIXIN_ALLOWED_USERS": {
        "description": "Comma-separated WeChat user IDs allowed to use the bot",
        "prompt": "Allowed WeChat user IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "WEIXIN_ALLOW_ALL_USERS": {
        "description": "Allow all WeChat users to message the bot (true/false)",
        "prompt": "Allow all WeChat users (true/false)",
        "url": None,
        "password": False,
        "category": "messaging",
        "advanced": True,
    ...
    "WEIXIN_HOME_CHANNEL": {
        "description": "Default WeChat chat ID for cron delivery",
